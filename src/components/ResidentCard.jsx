            ...
            <section className='card__body'>
                ...
                <ul className='card__list'>
                    <li className='card__item'>
                        ...
                        <span className='card__item-value'>{resident?.species}</span></li>
                    <li className='card__item'>
                        <span className='card__item-label'>Origin:</span>
                        <span className='card__item-value'>{resident?.origin.name}</span></li>
                    <li className='card__item'>
                        <span className='card__item-label'>Episodes it appear:</span>
                        <span className='card__item-value'>{resident?.episode.length}</span></li>
                </ul>
            </section>
        </article>
    )
